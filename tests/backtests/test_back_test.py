...
def test_create_backtest_data(test_data):
    ...
    with patch('src.back_test.back_test.PriceDataFetcher.get_price_data') as mock_price, \
         patch('src.back_test.back_test.RebalanceUtil.get_alpha_scores') as mock_alpha, \
         patch('src.back_test.back_test.RebalanceUtil.get_aum_leverage_data') as mock_aum:
...
def test_get_previous_rebalance_data(test_data):
    ...
    with patch('src.back_test.back_test.DataAccessUtil.fetch_data_from_db') as mock_fetch:
