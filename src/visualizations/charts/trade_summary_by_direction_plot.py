...
def plot_exposures_by_direction(df: pd.DataFrame) -> go.Figure:
    ...
    long_legend = go.Bar(x=[None], y=[None], marker_color=plotly_blue, name="Long")
    short_legend = go.Bar(x=[None], y=[None], marker_color=orangish_red, name="Short")
                ...
                "buttons": [
                    {
                        ...
                        "args": [
                            ...
                            {
                                "title": {
                                    "text": "Exposure by GICS Sector (Bar Chart)",
                                    "x": 0.5,
                                    "xanchor": "center",
                                },
                    ...
                    },
                    {
                        ...
                        "args": [
                            ...
                            {
                                "title": {
                                    "text": "Gross Exposure % by GICS sector",
                                    "x": 0.5,
                                    "xanchor": "center",
                                }
                            },
