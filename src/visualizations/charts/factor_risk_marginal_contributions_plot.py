...
if __name__ == "__main__":
    ...
    data = {
        'Factor': ['Manuf', 'BusEq', 'Durbl', 'NoDur', 'Enrgy', 'Telcm',
                   'Hlth', 'Chems', 'Utils', 'Money', 'Other', 'Shops'],
        'Risk Contribution': [0.0497, 0.0354, 0.0082, 0.0064, 0.0014, 0.0002,
                              -0.0003, -0.0004, -0.0005, -0.0012, -0.0013, -0.0048],
        'Contribution %': [0.5344, 0.3806, 0.0884, 0.0687, 0.0151, 0.0027,
                           -0.0031, -0.0038, -0.0054, -0.0128, -0.0137, -0.0512]
    }
