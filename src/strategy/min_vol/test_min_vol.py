...
def test_min_vol_signal_data_initialization(mock_universe_spec, mock_price_data, mock_benchmark_data, monkeypatch):
    # Mock the PriceDataFetcher methods
    monkeypatch.setattr(PriceDataFetcher, 'get_price_data', lambda *args, **kwargs: mock_price_data)
    monkeypatch.setattr(PriceDataFetcher, 'get_benchmark_data', lambda *args, **kwargs: mock_benchmark_data)
...
def test_calculate_signal_scores_shape_and_type(mock_universe_spec, mock_price_data, mock_benchmark_data, monkeypatch):
    # Mock the PriceDataFetcher methods
    monkeypatch.setattr(PriceDataFetcher, 'get_price_data', lambda *args, **kwargs: mock_price_data)
    monkeypatch.setattr(PriceDataFetcher, 'get_benchmark_data', lambda *args, **kwargs: mock_benchmark_data)
...
def test_calculate_signal_scores_values(mock_universe_spec, mock_price_data, mock_benchmark_data, monkeypatch):
    # Mock the PriceDataFetcher methods
    monkeypatch.setattr(PriceDataFetcher, 'get_price_data', lambda *args, **kwargs: mock_price_data)
    monkeypatch.setattr(PriceDataFetcher, 'get_benchmark_data', lambda *args, **kwargs: mock_benchmark_data)
